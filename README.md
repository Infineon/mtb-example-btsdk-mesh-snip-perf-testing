...
## Overview
This application can be used to test mesh performance. It uses a customized version of Mesh vendor specific model available in the SDK. See the document "AIROC-MeshClient-And-ClientControlMesh-User-Guide", section "Mesh Performance Testing".
...
2. Follow the "Testing Procedure" mentioned in the document "AIROC-MeshClient-And-ClientControlMesh-User-Guide".
